            ...
            if(!(user.equals("") || password.equals("")))
            {
                ...
                boolean is_present=false;
                    do{ 
                       ...
                       //checking if the random userid generated  already exixts in the table of database or not
                       DB.DB_Connector.st=DB.DB_Connector.con.createStatement();
                       ResultSet r=DB.DB_Connector.st.executeQuery("select* from user");

                         while(r.next())
                         {
                             if(Integer.parseInt(r.getString("UserId"))==int_random)
                             {
                                     is_present=true;
                             }
                         }
                ...
                DB.DB_Connector.st=DB.DB_Connector.con.createStatement();
                DB.DB_Connector.st.executeUpdate("insert into user values('"+Integer.toString(int_random)+"','"+user+"','"+password+"','0')");
