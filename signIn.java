...
public class signIn extends javax.swing.JFrame {
    ...
    public signIn() {
        initComponents();
        setDefaultCloseOperation(signIn.DISPOSE_ON_CLOSE);
    }
             ...
             if(!(username.equals("") && password.equals("")))
            {
                ...
                while(r.next())
                {
                    System.out.println("Inside while: ");
                       ...
                       System.out.println(r.getString("UserPass"));
                    if(r.getString("UserName").equals(username) && r.getString("UserPass").equals(password))
                    {
